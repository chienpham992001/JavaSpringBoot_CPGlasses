						...
						<div class="container">
							<div class="row">
								<div class="list-item col-lg-9 content-cart-page">
									...
									<c:if test="${nullCartItems!=null}">
										<div colspan="6" class="mt-2 alert alert-danger">${nullCartItems}</div>
								...
								<sf:form modelAttribute="saleOrder"
									...
									<div class="form-floating">
										<sf:input path="customerName" type="text" class="form-control"
											...
											placeholder="Họ và tên" value="${userLogined.fullname }"></sf:input>
									...
									<div class="form-floating">
										<sf:input path="customerPhone" type="text"
											...
											value="${userLogined.phone }"></sf:input>
									...
									<div class="form-group clearfix">
										...
										<c:if test="${!isLogined}">
											<a href="${base }/login"
												...
												onclick="alert('Vui lòng đăng nhập để mua hàng')">Thanh
												toán</a>
										</c:if>
										<c:if test="${isLogined}">
											<button type="submit"
