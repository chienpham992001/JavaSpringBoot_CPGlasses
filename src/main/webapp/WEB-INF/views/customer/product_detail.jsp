...
<body>
	...
	<main>
		...
		<div class="container">
			<div class="row">
				<div class="glass-img-detail col-lg-6 col-12 ml-4">
				...
				<div class="detail-info col-lg-4 col-12 mt-5">
					...
					<div class="special-offer">
						...
						<ul>
							...
							<li>Giá ưu đãi trong ngày hôm nay</li>
						</ul>
					</div>
							...
							<div class="col-md-12">
								<div class="card">
									<div class="comment-widgets m-b-20">
										<c:forEach items="${product.productReviews }" var="review">
											<div class="d-flex flex-row comment-row">
												...
												<div class="comment-text w-100">
													...
													<div class="comment-footer">
														<span class="action-icons"> <c:forEach begin="1"
																end="${review.rate }">
																<span class="fa fa-star vote"></span>
															</c:forEach> <c:forEach begin="${review.rate+1 }" end="5">
					...
					<div>
						<div class="row">
							...
							<div class="more_info col-lg-6 col-12">
								<div class="addition-info-content">Thương hiệu
									${product.categories.name} – biểu tượng quyền lực của thời
									trang</div>
