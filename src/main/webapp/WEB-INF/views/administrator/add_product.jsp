...
Edit product
</c:if> <c:if test="${product.id==null }">
Add new product
</c:if> | CP Glasses</title>
				...
				<div class="row">
					...
					<div class="col-9 mt-3">
						...
						<sf:form modelAttribute="product"
							...
							<sf:errors path="detail" cssClass="alert alert-danger"
								element="div"></sf:errors>
							<div class="mt-3">
								<label for="fileProductAvatar" class="form-label">Hỉnh
									ảnh</label> <input class="form-control" type="file"
							...
							<button type="button"
								class="btn btn-small btn-secondary mt-3 ms-3" onclick="javascript:history.go(-1)">Hủy</button>
