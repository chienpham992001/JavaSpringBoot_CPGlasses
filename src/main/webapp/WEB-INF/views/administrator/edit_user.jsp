			...
			<div class="main-content-inner form-input-data">
				...
				<div class="row">
					...
					<div class="col-9 mt-3">
						...
						<sf:form modelAttribute="user" action="${base}/admin/edit_user"
							method="post" class="mt-3 align-items-center">
							...
							<sf:input path="username" class="form-control" name="username" readonly="true"/>
							<sf:errors path="username" cssClass="alert alert-danger"
								element="div"></sf:errors>
							<c:if test="${existUsername!=null}">
								<div class="alert alert-danger">${existUsername}</div>
							</c:if>

							<label class="mt-3">Mật khẩu</label>
							<sf:input id="password" path="password" type="password" class="form-control"
								name="password" />
							...
							<button type="submit" class="btn btn-small btn-primary mt-3">Lưu</button>
							<button type="reset"
