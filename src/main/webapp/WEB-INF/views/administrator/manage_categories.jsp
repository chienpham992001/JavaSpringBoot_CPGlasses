			...
			<div class="main-content-inner">
				...
				<div class="row">
					...
					<div class="col-12 mt-3">
						<div class="card">
							<div class="card-body">
								<h1 class="header-title">Danh mục sản phẩm</h1>
											...
											<tbody style="line-height: 100px !important;">
												...
												<c:forEach items="${categories}" var="categories"
													...
													<tr>
														...
														<td class="description-${categories.id}">${categories.description}</td>
														...
														<td><a
															href="${base }/admin/addOrEdit_category/${categories.id}"><i
																...
																data-target="#modalDelete-${categories.id}"></i>
														</a></td>
														<c:set var="stt" value="${stt+1}"></c:set>
													</tr>
													<!--Modal thông báo  -->
													<div class="modal fade" id="modalDelete-${categories.id}">
														<div class="modal-dialog modal-dialog-centered"
															...
															<div class="modal-content">
																...
																<div class="modal-body">
																	<p>Bạn có chắc chắn muốn xóa thương hiệu này khỏi
																		hệ thống ?</p>
																</div>
																<div class="modal-footer">
																	...
																	<button type="button" class="btn btn-primary"
																		onclick="deleteCategory(${categories.id})">Xóa</button>
																</div>
															</div>
														</div>
													</div>
													<script type="text/javascript">
													var des = $(`.description-${categories.id}`).text();
													des = des.substring(0, 70);
													$(`.description-${categories.id}`).text(des+" ...")
													</script>
												</c:forEach>
