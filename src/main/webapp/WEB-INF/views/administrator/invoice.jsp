						...
						<div class="card">
							<div class="card-body">
								<div class="invoice-area">
									...
									<form class="form"
										style="margin: 0 auto; max-width: none; width: 900px;">
										<div class="container">
											<div class="row ">
												<div class="col-md-6">
													<div class="invoice-address">
														...
														<h6>Ghi chú : ${saleorder.customerNote}</h6>
													</div>
												</div>
														...
														<c:forEach items="${saleorderproducts }" var="hd">
															<tr>
																...
																<td><fmt:setLocale value="vi_VN" scope="session" />
																	<fmt:formatNumber value="${hd.product.price}"
								...
								<div class="invoice-buttons">
									<div class="text-left">
										...
										<c:if
											test="${saleorder.statusShipping !='Hoàn đơn' && saleorder.statusShipping !='Giao thành công'}">
											<c:choose>
												<c:when test="${saleorder.statusShipping =='Đang giao'}">
													...
													<button type="button" class="btn btn-danger"
														onclick="cancelSaleOrder(${saleorder.id })">Xác
									...
									<div class="text-right">
										...
										<a href="${base}/admin/manage_saleOrder">Quay lại</a>
									</div>
								</div>
